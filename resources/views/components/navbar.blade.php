        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="{{ "/" }}" class="flex ml-2 md:mr-24">
              <img src="/src/images/logo.svg" class="h-8 mr-3" alt="AstraVio Logo" />
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">AstraVio</span>
            </a>
