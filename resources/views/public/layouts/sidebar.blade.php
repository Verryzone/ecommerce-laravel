<aside id="sidebar"
    class="fixed top-0 left-0 z-20 hidden flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
    aria-label="Sidebar">
    <div
        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        ...
                        <ul id="dropdown-masterdata" class="space-y-2 py-2 {{ Route::is('management.products.list') ? '' : 'hidden' }}">
                            <li>
                                <a href="{{ route('management.products.list') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  {{ Route::is('management.products.list') ? 'bg-white' : 'bg-gray-100' }} dark:bg-gray-700">Products</a>
                            </li>
                            <li>
                                <a href=""
                    ...
                    {{-- <li>
                        ...
                        <ul id="dropdown-auth" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="{{ " authentication/reset-password/" }}"
                            ...
                            <li>
                                <a href="{{ " authentication/profile-lock/" }}"
...
<div class="fixed inset-0 z-10 hidden lg:hidden bg-gray-900/50 dark:bg-gray-900/90" id="sidebarBackdrop"></div>

<script>
    $(document).ready(function() {
        $('[data-collapse-toggle="dropdown-masterdata"]').on('click', function() {
            var dropdown = $(this).attr('aria-controls');
            $('#' + dropdown).slideToggle();

            // Rotasi ikon SVG
            $(this).find('svg[sidebar-toggle-item]').toggleClass('rotate-90');
        });
        ...
        $('#toggleSidebarMobile').on('click', function() {
            ...
            $('#toggleSidebarMobileHamburger').toggleClass('hidden');
            $('#toggleSidebarMobileClose').toggleClass('hidden');
