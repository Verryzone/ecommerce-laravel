<div id="drawer-update-product-default"
      ...
      <h5 id="drawer-label"
            ...
            Update Product</h5>
      <button type="button" id="update-drawer-cancel" data-drawer-dismiss="drawer-update-product-default"
      ...
      <form action="#">
            ...
            <div class="bottom-0 left-0 flex justify-center w-full pb-4 mt-4 space-x-4 sm:absolute sm:px-4 sm:mt-0">
                  ...
                  <button type="button" data-drawer-dismiss="drawer-create-product-default"
                    ...
                    class="drawer-close inline-flex w-full justify-center text-gray-500 items-center bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
...
<script>
      $(document).ready(function () {
            ...
            $('#update-drawer-cancel').click(function () {
