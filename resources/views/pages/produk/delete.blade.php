...
<script>
      $(document).ready(function () {
          $('.deleteProductButton').click(function () {
              $("#drawer-delete-product-default").removeClass('translate-x-full').addClass('translate-x-0')
          })
          
          $('.drawer-delete-cancel').click(function () {
              $("#drawer-delete-product-default").removeClass('translate-x-0').addClass('translate-x-full')
          })
